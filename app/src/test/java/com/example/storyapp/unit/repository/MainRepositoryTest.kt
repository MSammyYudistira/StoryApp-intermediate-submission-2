package com.example.storyapp.unit.repository
...
import com.example.storyapp.utils.DataDummy.generateDummyNewsEntity
...
class MainRepositoryTest {
    ...
    fun `verify getResponseLogin function is working`() {
        ...
        mainRepository.getLoginResponse(dummyRequestLogin)

        Mockito.verify(mainRepository).getLoginResponse(dummyRequestLogin)
